...
import store, { acceptOrder, getOrdersByStatus, getTodayOrders, setRole } from '@/store/index.js'
...
const handleAccept = (id) => { acceptOrder(id); uni.showToast({ title: '已接单 🎉', icon: 'none', duration: 1500 }) }
